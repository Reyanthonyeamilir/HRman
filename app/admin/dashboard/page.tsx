...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-white flex">
      {/* Sidebar - Reduced width for desktop */}
      <AdminSidebar open={sidebarOpen} setOpen={setSidebarOpen} user={user} />
      
      {/* Main Content - Reduced margin for desktop */}
            ...
            <div className="flex justify-between items-center py-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-xs sm:text-sm">Welcome, {user?.name}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2 sm:space-x-4">
                <div className="text-right hidden xs:block">
                  ...
                  <p className="font-semibold text-gray-900 text-xs sm:text-sm truncate max-w-[120px] sm:max-w-none">
                    {user?.email}
                  </p>
                </div>
                ...
                <button
                  ...
                  className="bg-blue-600 text-white p-2 sm:px-3 sm:py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center space-x-1 sm:space-x-2 shadow-sm"
                >
        ...
        <main className="flex-1 p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-6">
            ...
            <button
              ...
              className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm w-full sm:w-auto justify-center"
            >
              <svg 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-base font-semibold text-gray-700">Total Users</h3>
                  {statsLoading ? (
              ...
              <p className="text-sm text-gray-500 mt-2">Registered users in system</p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-base font-semibold text-gray-700">Applications</h3>
                  {statsLoading ? (
                    <div className="animate-pulse bg-gray-200 h-8 w-16 rounded mt-2"></div>
                  ) : (
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-base font-semibold text-gray-700">HR Staff</h3>
                  {statsLoading ? (
                    <div className="animate-pulse bg-gray-200 h-8 w-16 rounded mt-2"></div>
                  ) : (
                    <p className="text-3xl font-bold text-blue-600 mt-2">{stats.totalHRStaff}</p>
                  )}
                </div>
                <div className="bg-blue-100 p-3 rounded-full">
                  <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-500 mt-2">HR team members</p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-base font-semibold text-gray-700">Pending Reviews</h3>
                  {statsLoading ? (
                    <div className="animate-pulse bg-gray-200 h-8 w-16 rounded mt-2"></div>
                  ) : (
                    <p className="text-3xl font-bold text-blue-600 mt-2">{stats.pendingReviews}</p>
                  )}
                </div>
                <div className="bg-blue-100 p-3 rounded-full">
                  <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-500 mt-2">Applications awaiting review</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <button
                ...
                className="bg-blue-600 text-white px-4 py-4 rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center space-x-2 shadow-sm hover:shadow-md"
              >
