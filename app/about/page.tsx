      ...
      <section className="py-12 md:py-16">
        <div className="mx-auto w-full max-w-6xl px-4">
          <div className="mb-4 text-center">
            ...
            <h2 className="text-2xl font-semibold md:text-3xl">Who we are and what we do</h2>
          </div>

          <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
            <div className="overflow-hidden rounded-[14px] border border-slate-200 bg-white shadow-sm transition hover:-translate-y-[2px] hover:shadow-[0_16px_40px_rgba(2,8,23,0.12)]">
              <div className="p-4">
                <h3 className="text-lg font-semibold">Our Mission</h3>
                <p className="mt-1 text-sm text-slate-600">
                  To support NORSU employees with fair, transparent, and efficient HR services.
                </p>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-[14px] border border-slate-200 bg-white shadow-sm transition hover:-translate-y-[2px] hover:shadow-[0_16px_40px_rgba(2,8,23,0.12)]">
              <div className="p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Recruitment, onboarding, benefits administration, employee relations, and development.
                </p>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-[14px] border border-slate-200 bg-white shadow-sm transition hover:-translate-y-[2px] hover:shadow-[0_16px_40px_rgba(2,8,23,0.12)]">
              <div className="p-4">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Reach us via the help desk for any HR-related requests and concerns.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-6 px-4 py-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="grid gap-2">
            ...
            <li><a href="/about" aria-current="page" className="text-slate-200 hover:underline">About HR</a></li>
